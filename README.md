...
- ### Arrays
    ...
    - [v] Description:
        ...
        - [v][Arrays (video)](https://www.coursera.org/lecture/data-structures/arrays-OsBSF)
        - [v][UC Berkeley CS61B - Linear and Multi-Dim Arrays (video)](https://archive.org/details/ucberkeley_webcast_Wp8oiO_CZZE) (Start watching from 15m 32s)
        - [v][Dynamic Arrays (video)](https://www.coursera.org/lecture/data-structures/dynamic-arrays-EwbnV)
    ...
    - [v] Implement a vector (mutable array with automatic resizing):
        - [ v] Practice coding using arrays and pointers, and pointer math to jump to an index instead of using indexing.
        - [ v] New raw data array with allocated memory
            - can allocate int array under the hood, just not use its features
            - start with 16, or if starting number is greater, use power of 2 - 16, 32, 64, 128
        - [ v] size() - number of items
        - [ v] capacity() - number of items it can hold
        - [ v] is_empty()
        - [ v] at(index) - returns item at given index, blows up if index out of bounds
        - [ v] push(item)
        - [ v] insert(index, item) - inserts item at index, shifts that index's value and trailing elements to the right
        - [v ] prepend(item) - can use insert above at index 0
        - [ v] pop() - remove from end, return value
        - [ v] delete(index) - delete item at index, shifting all trailing elements left
        - [v ] remove(item) - looks for value and removes index holding it (even if in multiple places)
        - [v ] find(item) - looks for value and returns first index with that value, -1 if not found
        - [v ] resize(new_capacity) // private function
...
- https://github.com/LeeJin0527/coding-interview-university/blob/main/DataStructure/Linked_List_1.md  (정리본1)
    ...
    - [ ] Implement (I did with tail pointer & without):
        - [ v] size() - returns number of data elements in list
        - [ v] empty() - bool returns true if empty
        - [ v] value_at(index) - returns the value of the nth item (starting at 0 for first)
        - [v ] push_front(value) - adds an item to the front of the list
        - [v ] pop_front() - remove front item and return its value
        - [v ] push_back(value) - adds an item at the end
        - [v ] pop_back() - removes end item and returns its value
        - [v ] front() - get value of front item
        - [v ] back() - get value of end item
        - [v ] insert(index, value) - insert value at index, so current item at that index is pointed to by new item at index
        - [ ] 
        - [v ] erase(index) - removes node at given index
        - [ v] value_n_from_end(n) - returns the value of the node at nth position from the end of the list
        - [ v] reverse() - reverses the list
        - [v ] remove_value(value) - removes the first item in the list with this value
    - [ ] Doubly-linked List
